...
CERTIFICATION_BASE = "/eos/user/c/cmsdqm/www/CAF/certification/Collisions23/DCSOnly_JSONS/dailyDCSOnlyJSON"
...
JSON_PATTERN = "Collisions23_13p6TeV_(\d+)_(\d+)_DCSOnly_TkPx.json"
