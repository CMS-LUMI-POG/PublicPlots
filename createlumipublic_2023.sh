...
# Overall run script for 2023. Now that we have normtags available, this is basically identical to the 2017
# script.
...
#python create_public_lumi_plots.py public_brilcalc_plots_pp_2023_online.cfg
#mkdir -p /eos/user/l/lumipro/www/publicplots/2023
#cp plots/2023/online/*2023*Online*png plots/2023/online/*2023*Online*pdf /eos/user/l/lumipro/www/publicplots/2023
#
# 1b) same, with normtag luminosity
python create_public_lumi_plots.py public_brilcalc_plots_pp_2023_normtag.cfg
cp plots/2023/normtag/*2023*Normtag*png plots/2023/normtag/*2023*Normtag*pdf /eos/user/l/lumipro/www/publicplots/2023
#
# 2) Copy the cache into the cache for the all years plots. Note: uses normtag now!
cp public_lumi_plots_cache/pp_2023_normtag/* public_lumi_plots_cache/pp_all/
#
# 3) Copy cache to public location
#cp -R -u public_lumi_plots_cache/pp_2023_online /afs/cern.ch/user/l/lumipro/public/lumiCache/
cp -R -u public_lumi_plots_cache/pp_2023_normtag /afs/cern.ch/user/l/lumipro/public/lumiCache/
