...
def GetLabel(year, accel_mode, mode):
    ...
    label_spec = {
        ...
        "cum_day" : "CMS Offline Luminosity (Preliminary)",
        "cum_week" : "CMS Offline Luminosity (Preliminary)",
        "cum_year" : "CMS Offline Luminosity (Preliminary)",
        "max_inst" : "CMS Offline Luminosity (Preliminary)",
        }
        },
        "IONPHYS" : {
        2011 : {
        ...
        #"max_inst" : "CMS Online Luminosity",
        #"cum_day" : "Preliminary",
        #"cum_week" : "Preliminary",
        #"cum_year" : "Preliminary",
        #"max_inst" : "Preliminary",
        "cum_day" : "CMS Offline Luminosity (Preliminary)",
        "cum_week" : "CMS Offline Luminosity (Preliminary)",
        "cum_year" : "CMS Offline Luminosity (Preliminary)",
        "max_inst" : "CMS Offline Luminosity (Preliminary)",
...
def TweakPlot(fig, ax, (time_begin, time_end),
    ...
    if add_extra_head_room:
        ...
        if is_log:
            ...
            tmp = y_ticks[-1] - y_ticks[-2]
            y_max_new = y_max + add_extra_head_room * (1.5*tmp)
