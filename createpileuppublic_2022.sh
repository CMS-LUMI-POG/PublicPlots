...
CMSSWPATH=/eos/user/s/schwick/CMSSW/CMSSW_8_0_0
(
    cd $CMSSWPATH
    ...
    #python run_pileupCalc.py public_pileup_plots_pp_2022_69200.cfg 
)
...
#python create_public_pileup_plots.py public_pileup_plots_pp_2022_69200.cfg 

#cp plots/2022/normtag/pileup_pp_2022* /eos/user/l/lumipro/www/publicplots/

# Now make sure that the same rootfile is in both cache directories.
#cp /afs/cern.ch/user/l/lumipro/PublicPlots/public_lumi_plots_cache/pileup_2022/pileup_calc_80000_tmp.root /afs/cern.ch/user/l/lumipro/PublicPlots/public_lumi_plots_cache/pileup_all/PileupHistogram-goldenJSON-13tev-2022.root
