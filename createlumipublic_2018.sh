...
cp plots/2018/online/*2018*OnlineLumi*png plots/2018/online/*2018*OnlineLumi*pdf /eos/user/l/lumipro/www/publicplots/

# 1b) same, with normtag luminosity
python create_public_lumi_plots.py public_brilcalc_plots_pp_2018_normtag.cfg
cp plots/2018/normtag/*2018*NormtagLumi*png plots/2018/normtag/*2018*NormtagLumi*pdf /eos/user/l/lumipro/www/publicplots/
...
cp plots/allYears/peak_lumi_pp* plots/allYears/int_lumi_cumulative_pp* plots/allYears/int_lumi_allcumulative_pp* plots/allYears/lumiByDay.csv /eos/user/l/lumipro/www/publicplots/
