...
if __name__ == "__main__":
    ...
    energyPPb = float(cfg_parser.get("general", "energyPPb"))
    file_suffix2 = cfg_parser.get("general", "file_suffix2")
      ...
      if year != 2014:
        ...
        if accel_mode == "PROTPHYS":
            ...
            cms_energy_str = "%.2f TeV/nucleon" % \
                             (1.e-3 * GetEnergyPerNucleonScaleFactor(accel_mode) * energyPPb)
